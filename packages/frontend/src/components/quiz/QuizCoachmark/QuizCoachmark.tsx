...
const CLASS_NAME_SELECTOR_PREFIX = ".";

const STEPS: CoachmarkProps["steps"] = [
  {
    title: "Git 그래프",
    target: CLASS_NAME_SELECTOR_PREFIX + COACHMARK_TARGETS.GIT_GRAPH,
    content:
  ...
  {
    title: "Git 핵심 명령어",
    target: CLASS_NAME_SELECTOR_PREFIX + COACHMARK_TARGETS.KEY_COMMAND,
    content: "문제 풀이에 필요한 핵심 명령어를 확인할 수 있어요.",
    placement: "bottom",
  },
  {
    title: "문제 풀이용 터미널",
    target: CLASS_NAME_SELECTOR_PREFIX + COACHMARK_TARGETS.TERMINAL,
    content: "터미널에 Git 명령어를 입력해 문제를 풀어보세요.",
    placement: "top-start",
  },
  {
    title: "터미널 리사이징",
    target: CLASS_NAME_SELECTOR_PREFIX + COACHMARK_TARGETS.RESIZABLE,
